...
$sql=$wpdb->prepare("INSERT IGNORE  into wp_coordinates (recordid,lat,lng,country) values (%s,%f,%f,%s)",array($city->recordid,$city->fields->coordinates[0],$city->fields->coordinates[1],$city->fields->country));
$wpdb->query($sql);
}
